...
<html lang="en">
    ...
    <body>
        <div class='container'>
            <!-- include page content. The following links are used to send requests-->
            <p><a href="example07.php?type=Drama">Drama Movies</a></p>
            <p><a href="example07.php?type=Adventure">Adventure Movies</a> </p>
            <p><a href="example07.php?type=Action">Action Movies</a> </p>
